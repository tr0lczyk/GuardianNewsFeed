...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class GuardianPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener{
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference newsLimit = findPreference(getString(R.string.news_limit_key));
            signUpPreferenceToValue(newsLimit);

            Preference section = findPreference(getString(R.string.section_key));
            signUpPreferenceToValue(section);
        ...
        private void signUpPreferenceToValue(Preference preference){
